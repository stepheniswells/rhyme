    ...
    return (
      <div>
        ...
        <form onSubmit={registerUser}>
            ...
            <input type="password" value={password} placeholder='Enter a password' onChange={onChange} name='password'/>
            <input type="password" value={password2} placeholder='Confirm password' onChange={onChange} name='password2'/>
